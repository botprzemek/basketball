...
use crate::{providers::PostgresProvider, repositories::organizations::dsl::*};
use api_domain::{entities::Organization, ports::OrganizationPort};
...
#[diesel(table_name = crate::repositories::organizations)]
